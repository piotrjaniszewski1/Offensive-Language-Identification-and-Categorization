...
OffensEval 2020: Multilingual Offensive Language Identification in Social Media (SemEval 2020 - Task 12)
...
The file test_b_tweets.tsv contains 850 unlabeled tweets. This file contains ONLY tweets which are offensive AND targeted.

You are required to upload your sub-task B predictions for each of the 850 instances to CodaLab by no later than 11 Mar 2020 (23:59 GMT).

You will find ALL the necessary information regarding data format, dates, number of submissions, etc. at CodaLab. Please read it carefully.
...
When you have your model predictions, you should upload a ZIP file containing a CSV file on CodaLab in the following format. 
